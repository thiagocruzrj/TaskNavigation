...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.activity_infomacao_pessoal) {
            activityInformacaoPessoal();
        } else if (id == R.id.activity_formacao) {
            activityFormacao();
        } else if (id == R.id.activity_experiencia_profissional) {
            activityExperienciaProfissional();
    ...
    void activityExperienciaProfissional(){
        Intent i = new Intent();
        i.setClass(MainActivity.this, ExperienciaProfissional.class);
        startActivity(i);
        finish();
    }
